...
PidginDiscoDialog *pidgin_disco_dialog_new(void)
{
	 ...
	 * expand=TRUE), which would collapse this whole body -- the service
	 * treeview scroller lives inside vbox2 -- to its minimum and leave a void
	 * when the dialog is resized taller. Pack it as the expanding child. */
