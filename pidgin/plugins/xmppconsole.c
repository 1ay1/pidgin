...
static void iq_clicked_cb(GtkWidget *w, gpointer nul)
{
	...
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "get");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "set");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "result");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "error");
	...
	stanza = g_strdup_printf("<iq %s%s%s id='console%x' type='%s'></iq>",
				 ...
				 to && *to ? "'" : "",
				 g_random_int(),
				 gtk_combo_box_text_get_active_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo))));
...
static void presence_clicked_cb(GtkWidget *w, gpointer nul)
{
	...
	gtk_box_pack_start(GTK_BOX(hbox), label, FALSE, FALSE, 0);
	type_combo = gtk_combo_box_text_new();
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "default");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "unavailable");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "subscribe");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "unsubscribe");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "subscribed");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "unsubscribed");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "probe");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "error");
	gtk_combo_box_set_active(GTK_COMBO_BOX(type_combo), 0);
	gtk_box_pack_start(GTK_BOX(hbox), type_combo, FALSE, FALSE, 0);
	...
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(show_combo)), "default");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(show_combo)), "away");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(show_combo)), "dnd");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(show_combo)), "xa");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(show_combo)), "chat");
	...
	to = gtk_entry_get_text(GTK_ENTRY(to_entry));
	type = gtk_combo_box_text_get_active_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)));
	if (purple_strequal(type, "default"))
		type = "";
	show = gtk_combo_box_text_get_active_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(show_combo)));
...
static void message_clicked_cb(GtkWidget *w, gpointer nul)
{
	...
	gtk_box_pack_start(GTK_BOX(hbox), label, FALSE, FALSE, 0);
	type_combo = gtk_combo_box_text_new();
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "chat");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "headline");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "groupchat");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "normal");
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(type_combo)), "error");
	gtk_combo_box_set_active(GTK_COMBO_BOX(type_combo), 0);
	gtk_box_pack_start(GTK_BOX(hbox), type_combo, FALSE, FALSE, 0);
...
signing_on_cb(PurpleConnection *gc)
{
	...
	gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(console->dropdown)), purple_account_get_username(gc->account));
...
signed_off_cb(PurpleConnection *gc)
{
	...
	gtk_combo_box_text_remove(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(console->dropdown)), i);
...
static void
console_destroy(GObject *window, gpointer nul)
{
...
dropdown_changed_cb(GtkComboBox *widget, gpointer nul)
{
	...
	account = purple_accounts_find(gtk_combo_box_text_get_active_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(console->dropdown))),
				    "prpl-jabber");
...
create_console(PurplePluginAction *action)
{
	...
	for (connections = purple_connections_get_all(); connections; connections = connections->next) {
		...
		if (purple_strequal(purple_account_get_protocol_id(purple_connection_get_account(gc)), "prpl-jabber")) {
			console->count++;
			console->accounts = g_list_append(console->accounts, gc);
			gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(GTK_COMBO_BOX(console->dropdown)),
