...
create_details()
{
	...
	pidgin_widget_set_alignment(GTK_WIDGET(plugin_name), 0, 0);
	...
	pidgin_widget_set_alignment(GTK_WIDGET(plugin_error), 0, 0);
	...
	pidgin_widget_set_alignment(GTK_WIDGET(plugin_author), 0, 0);
	...
	pidgin_widget_set_alignment(GTK_WIDGET(plugin_website), 0, 0);
	...
	pidgin_widget_set_alignment(GTK_WIDGET(plugin_filename), 0, 0);
...
void pidgin_plugin_dialog_show()
{
	...
	gtk_box_pack_start(GTK_BOX(gtk_dialog_get_content_area(GTK_DIALOG(plugin_dialog))), expander,
		FALSE, FALSE, 0);
